...
function buildLongPath(){
  ...
  PATH_REGIONS.forEach((region,i)=>{
    ...
    el.innerHTML=`
      <div class="region-art"></div>
      <div class="region-art-shade"></div>
